...
CCH_recent_additions <- read_csv("data_Yosemite/Yosemite_CCH_recent_additions.csv") %>% mutate(source = "voucher")
...
Yos_long_unseen <- 
  ...
  theme(
    ...
    plot.margin=unit(c(.03,.0,.0,.1),"cm")
  )
...
Yos_new_discoveries_tmp <-
  ...
  geom_sf(mapping = aes(), data = yosemite_outline , stat = "sf", fill = "#C5DDC2", color = "grey50") +
  geom_sf(mapping = aes(), data = yos_roads_clipped, stat = "sf") +
  geom_point(aes(longitude, latitude, col = factor(establishment_means), shape = factor(source)), data = recent_additions_all, position = "jitter") +
...
Royal_long_unseen <-
  ...
  geom_point(aes(longitude, latitude, col = factor(establishment_means)), data = Royal_long_unseen_locations, position = "jitter") +
...
Royal_new_discoveries <-
  ...
  geom_sf(mapping = aes(), data = royal_outline , stat = "sf", fill = "#C5DDC2", color = "grey50") +
  geom_sf(mapping = aes(), data = royal_roads_clipped, stat = "sf") +
  geom_point(aes(longitude, latitude, col = factor(establishment_means), shape = factor(source)), data = Royal_recent_additions_all, position = "jitter") +
